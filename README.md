...
currently_learning: Node.js & Advanced Laravel Architecture
fun_fact: Turning coffee into clean and scalable web applications ☕
```

- 🔭 I’m currently focused on building modern and responsive **Web Applications**.
- 🌱 Always learning, exploring new technologies, and currently deepening **Node.js**.
- 💬 Ask me about **HTML, CSS, JavaScript, PHP, Laravel, and Firebase**.
- ⚡ In my free time, I explore new tools, design UI concepts, and work on creative side projects.
